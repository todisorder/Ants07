...
static string BorderBehavior = "restart";       // "restart" or "periodic"
...
static int const MaxActiveDropletsPerAnt = 1000;    // 1000
...
static double const Turn_off_random = 6.*1.;    //*0.02;
//  ^^^ 0. = No Random!
...
static double const Threshold = 4.; //
